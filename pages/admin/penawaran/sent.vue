    ...
    <v-col cols="10">
      <v-breadcrumbs>
        <v-breadcrumbs-item active>
          <span class="font-weight-medium text-h5"> Penawaran Terkirim</span>
        </v-breadcrumbs-item>
      </v-breadcrumbs>
    </v-col>
  </v-row>
  ...
  <v-card flat rounded="lg" class="border">
    ...
    >
      ...
      <template v-slot:item.perihal="{ item }">
        <div style="width: 180px" class="text-wrap-column font-weight-medium">
          {{ item.perihal }}
        </div>
      </template>
